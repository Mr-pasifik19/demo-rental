...
Route::post('/update-alarm-status/{id}', [AlarmController::class, 'updateStatus'])->name('update-alarm-status');
Route::delete('/delete-alarm/{id}', [AlarmController::class, 'deleteAlarm'])->name('delete-alarm');
Route::post('/save-task', [AlarmController::class, 'saveTask'])->name('save.task');
