...
Route::group(['prefix' => 'v1', 'middleware' => ['api', 'throttle:api']], function () {
    ...
    Route::get('companies/getName', [Api\CompaniesController::class, 'getNameCompany'])->name('api.company.getName');
    Route::resource(
        'companies',
        Api\CompaniesController::class,
        [
    ...
    Route::get('fields/save-field', [Api\CustomFieldsController::class, 'addNewFieldValues'])->name('api.fields.saveField');
    Route::resource(
        'fields',
        Api\CustomFieldsController::class,
        [
    ...
    Route::get('hardware/thirdParty', [Api\AssetsController::class, 'getAssetThirdParty'])->name('api.assets.thirdParty');
    Route::get('hardware/movement/changeStatus', [Api\AssetsController::class, 'changeStatusAssetForReturnMovement'])->name('api.assets.changeStatus');
    Route::resource(
        'hardware',
        Api\AssetsController::class,
        [
    ...
    // Route::resource(
    //     'movementAsset',
    //     Api\MovementAssetsController::class,
    //     [
    //         'names' => [
    //             'index' => 'api.movement.index',
    //         ],
    //     ]
    // );
    ...
    Route::group(['prefix' => 'users'], function () {
        ...
        Route::post('storeUserForMovement', [
            Api\UsersController::class,
            'storeUserForMovement'
        ])->name('api.users.storeUserForMovement');
    });
