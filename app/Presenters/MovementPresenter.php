 ...
 */
class MovementPresenter extends Presenter
{
    /**
    ...
    //             'searchable' => true,
    //             'sortable' => true,
    //             'title' => trans('admin/movement/table.movement_tag'),
    //             'visible' => true,
    ...
    //             //     'sortable' => true,
    //             //     'switchable' => true,
    //             //     'title' => trans('admin/movement/table.image'),
    //             //     'visible' => true,
    ...
    //             //     'searchable' => true,
    //             //     'sortable' => true,
    //             //     'title' => trans('admin/movement/form.serial'),
    //             //     'visible' => true,
    //             //     'formatter' => 'hardwareLinkFormatter',
    //             // ],  [
    //             //     'field' => 'model',
    //             //     'searchable' => true,
    //             //     'sortable' => true,
    //             //     'title' => trans('admin/movement/form.model'),
    //             //     'visible' => true,
    ...
    //             'searchable' => true,
    //             'sortable' => true,
    //             'title' => trans('admin/movement/table.status'),
    //             'visible' => true,
    ...
    //             'searchable' => true,
    //             'sortable' => true,
    //             'title' => trans('admin/movement/form.checkedout_to'),
    //             'visible' => true,
    ...
    //             'searchable' => true,
    //             'sortable' => true,
    //             'title' => trans('admin/movement/table.location'),
    //             'visible' => true,
    ...
    //             'searchable' => true,
    //             'sortable' => true,
    //             'title' => trans('admin/movement/form.default_location'),
    //             'visible' => false,
    //             'formatter' => 'deployedLocationFormatter',
    //         ], [
    //             'field' => 'manufacturer',
    ...
    //         ],
    //         [
    //             'field' => 'movement_eol_date',
    //             'searchable' => true,
    //             'sortable' => true,
    //             'visible' => false,
    //             'title' => trans('admin/movement/form.eol_date'),
    //             'formatter' => 'dateDisplayFormatter',
    //         ], [
    ...
    //             'sortable' => true,
    //             'visible' => false,
    //             'title' => trans('admin/movement/form.warranty'),
    //         ], [
    //             'field' => 'warranty_expires',
    //             'searchable' => false,
    //             'sortable' => false,
    //             'visible' => false,
    //             'title' => trans('admin/movement/form.warranty_expires'),
    //             'formatter' => 'dateDisplayFormatter',
    //         ], [
    //             'field' => 'notes',
    //             'searchable' => true,
    ...
    //             'sortable' => true,
    //             'visible' => false,
    //             'title' => trans('admin/movement/table.checkout_date'),
    //             'formatter' => 'dateDisplayFormatter',
    //         ], [
    ...
    //             'sortable' => true,
    //             'visible' => false,
    //             'title' => trans('admin/movement/form.expected_checkin'),
    //             'formatter' => 'dateDisplayFormatter',
    //         ], [
    ...
    {
        return (string) link_to_route('movement.show', e($this->movement_number), $this->id);
    }
    ...
    public function imageUrl()
    {
        ...
        $url = config('app.url');
        if (!empty($imagePath)) {
            $imagePath = '<img src="' . $url . '/uploads/movement/' . $imagePath . ' height="50" width="50" alt="' . $imageAlt . '">';
        }
    ...
    public function imageSrc()
    {
        ...
        if (!empty($imagePath)) {
            return config('app.url') . '/uploads/movement/' . $imagePath;
        }
    ...
    public function fullName()
    {
        ...
        // Asset tag
        if ($this->movement_tag) {
            $str .= ' (' . $this->model->movement_tag . ')';
        }
    ...
    {
        return route('movement.show', $this->id);
    }

    public function glyph()
    {
        return '<i class="fas fa-save" aria-hidden="true"></i>';
    }
}
