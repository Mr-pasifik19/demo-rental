...
/**
 * Class MovementModelPresenter
 */
class MovementModelPresenter extends Presenter
{
    public static function dataTableLayout()
    {
        $layout = [
            ...
            [
                ...
                'sortable' => true,
                'switchable' => true,
                'title' => trans('admin/models/table.nummovements'),
                'visible' => true,
            ],
            [
                'field' => 'depreciation',
            ...
            [
                ...
                'sortable' => true,
                'visible' => false,
                'title' => trans('admin/movement/general.requestable'),
