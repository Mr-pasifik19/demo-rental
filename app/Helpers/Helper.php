...
class Helper
{
    ...
    */
    ...
    {
        $settings = ['#', 'fields.index', 'statuslabels.index', 'family.index', 'categories.index', 'manufacturers.index', 'suppliers.index', 'departments.index', 'locations.index', 'companies.index', 'depreciations.index'];
     ...
     * GET data time UTC
     */
    public static function dateTimeUTC()
    {
        ///! Current Date Time
        ...
        return $utcDateTime->setTimezone(new DateTimeZone('UTC'));
    }
}
