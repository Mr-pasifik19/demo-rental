...
/**
 * Model for movement Models. movement Models contain higher level
 * attributes that are common among the same type of movement.
 *
 * @version    v1.0
 */
class MovementModel extends SnipeModel
{
    use HasFactory;
    use SoftDeletes;
    protected $presenter = \App\Presenters\MovementModelPresenter::class;
    ...
    /**
     * Establishes the model -> movements relationship
     *
    ...
    {
        return $this->hasMany(\App\Models\Movement::class, 'model_id');
    }
    ...
    public function uploads()
    {
        return $this->hasMany('\App\Models\Actionlog', 'item_id')
            ->where('item_type', '=', MovementModel::class)
