    ...
    public function transformActionlog(Actionlog $actionlog, $settings = null)
    {
        ...
        $array = [
            ...
            'target' => ($actionlog->target) ? [
                ...
                'name' => ($actionlog->targetType() == 'user') ? e($actionlog->target->getFullNameAttribute()) : (($actionlog->targetType() == 'movement') ? e($actionlog->target->getMovementAttribute()) : e($actionlog->target->getDisplayNameAttribute())),
