...
class AssetModelsController extends Controller
{
    ...
    public function store(ImageUploadRequest $request)
    {
        ...
        if ($model->save()) {
            ...
            return redirect()->route('family.index')->with('success', trans('admin/models/message.create.success'));
        }
    ...
    public function edit($modelId = null)
    {
        ...
        return redirect()->route('family.index')->with('error', trans('admin/models/message.does_not_exist'));
    }
    ...
    public function update(ImageUploadRequest $request, $modelId = null)
    {
        ...
        if ($model->save()) {
            return redirect()->route('family.index')->with('success', trans('admin/models/message.update.success'));
        }
    ...
    public function destroy($modelId)
    {
        ...
        // Check if the model exists
        if (is_null($model = AssetModel::find($modelId))) {
            return redirect()->route('family.index')->with('error', trans('admin/models/message.not_found'));
        }

        if ($model->assets()->count() > 0) {
            // Throw an error that this model is associated with assets
            return redirect()->route('family.index')->with('error', trans('admin/models/message.assoc_users'));
        }
        ...
        // Redirect to the models management page
        return redirect()->route('family.index')->with('success', trans('admin/models/message.delete.success'));
    }
    ...
    public function getRestore($modelId = null)
    {
        ...
        if (isset($model->id)) {
            ...
            return redirect()->route('family.index')->with('success', trans('admin/models/message.restore.success'));
        }
