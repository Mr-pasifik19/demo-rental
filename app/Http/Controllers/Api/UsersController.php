...
class UsersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        ])->with('groups', 'userloc', 'company', 'department', 'assets', 'licenses', 'accessories', 'consumables', 'createdBy',);
    ...
    public function storeUserForMovement(Request $request)
    {
        $this->authorize('create', User::class);
