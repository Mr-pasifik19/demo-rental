...
class CompaniesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        ///
        // 'licenses as licenses_count', 'accessories as accessories_count', 'consumables as consumables_count', 'components as components_count', 'users as users_count'
    ...
    public function getNameCompany(Request $request)
    {

        try {
            $company = Company::find($request->id);
            return response()->json(Helper::formatStandardApiResponse('success', $company->name, 'Success get name company'));
        } catch (\Throwable $e) {
            return response()->json(Helper::formatStandardApiResponse('error', null, 'Failed get name company'));
        }
    }
}
