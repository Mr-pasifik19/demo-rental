    ...
    public function store(AssetFileRequest $request, $assetId = null)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            foreach ($request->file('file') as $file) {
                ...
                $file_name = 'movement-'.$asset->id.'-'.str_random(8).'-'.str_slug(basename($file->getClientOriginalName(), '.'.$extension)).'.'.$extension;
            ...
            return redirect()->back()->with('success', trans('admin/movement/message.upload.success'));
        }
