...
echo "--------------------------------------------------------\n";
echo "WELCOME TO THE Hantechno Rental App UPGRADER! \n";
echo "--------------------------------------------------------\n\n";
...
if (version_compare(PHP_VERSION, $required_php_min, '<')) {
    echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! ERROR !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n";
    echo "This version of PHP (".PHP_VERSION.") is not compatible with Hantechno Rental App.\n";
    echo "Hantechno Rental App requires PHP version ".$required_php_min." or greater. Please upgrade \n";
