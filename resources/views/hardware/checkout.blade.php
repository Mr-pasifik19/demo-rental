                    ...
                    <div class="box-body">
                        ...
                        @if ($asset->company && $asset->company->name)
                            <div class="form-group">
                                {{ Form::label('model', trans('general.company'), ['class' => 'col-md-3 control-label']) }}
                                <div class="col-md-8">
                        ...
                        @include('partials.forms.edit.movement-select', [
                            'translated_name' => trans('general.movement'),
                            'fieldname' => 'assigned_movement',
                            'style' => 'display:none;',
                            'required' => 'true',
                        ])
                        ...
                        <div class="form-group {{ $errors->has('checkout_at') ? 'error' : '' }}">
                            {{ Form::label('checkout_at', trans('admin/hardware/form.checkout_date'), ['class' => 'col-md-3 control-label']) }}
                            <div class="col-md-8">
                        ...
                        <div class="form-group {{ $errors->has('expected_checkin') ? 'error' : '' }}">
                            {{ Form::label('expected_checkin', trans('admin/hardware/form.expected_checkin'), ['class' => 'col-md-3 control-label']) }}
                            <div class="col-md-8">
                                <div class="input-group date col-md-7" data-provide="datepicker"
