...
@section('header_right')
    ...
    @can('create', \App\Models\Asset::class)
        <a href="{{ route('hardware.create') }}" accesskey="n" class="btn btn-primary pull-right"></i>
...
@section('moar_scripts')
    ...
    <script>
        $(document).ready(function() {
            $('#action_bulk').change(function() {
                var value = $(this).val();
                if (value === 'labels') {
                    $('#assetsBulkForm').attr('target', '_blank');
                } else {
                    $('#assetsBulkForm').removeAttr('target');
                }
            });
        });
    </script>
