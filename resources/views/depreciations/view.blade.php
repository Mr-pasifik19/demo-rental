...
@section('title')
    ...
    {{ trans('general.depreciation') }}: {{ $depreciation->name }} ({{ $depreciation->months }}
...
@section('header_right')
    <div class="btn-group pull-right">
        ...
        <ul class="dropdown-menu">
            <li><a
                    href="{{ route('depreciations.edit', ['depreciation' => $depreciation->id]) }}">{{ trans('general.update') }}</a>
            </li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="assets">
                        ...
                        <table data-columns="{{ \App\Presenters\AssetPresenter::dataTableLayout() }}"
                            data-cookie-id-table="depreciationsAssetTable" data-id-table="depreciationsAssetTable"
                            id="depreciationsAssetTable" data-pagination="true" data-search="true"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive">
                                    <table data-columns="{{ \App\Presenters\AssetModelPresenter::dataTableLayout() }}"
                                        ...
                                        data-id-table="depreciationsModelsTable" id="depreciationsModelsTable"
                                        data-pagination="true" data-search="true" data-toolbar="#toolbar"
                                        data-side-pagination="server" data-show-columns="true" data-show-export="true"
                                        data-show-refresh="true" data-sort-order="asc" data-sort-name="name"
                                        class="table table-striped snipe-table"
