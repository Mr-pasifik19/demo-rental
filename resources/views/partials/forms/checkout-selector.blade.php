<div class="form-group" id="assignto_selector"{!!  (isset($style)) ? ' style="'.e($style).'"' : ''  !!}>
    ...
    <div class="col-md-8">
        <div class="btn-group" data-toggle="buttons">
            ...
            <label class="btn btn-default">
                <input name="checkout_to_type" value="location" aria-label="checkout_to_type" type="radio"><i class="fas fa-map-marker-alt" aria-hidden="true"></i> {{ trans('general.location') }}
            </label>
            @endif --}}
            @if ((isset($movement_select)) && ($movement_select!='false'))
            <label class="btn btn-default">
                <input name="checkout_to_type" value="movement" aria-label="checkout_to_type" type="radio"><i class="fas fa-save" aria-hidden="true"></i> {{ trans('general.movement') }}
            </label>
            @endif
