                    ...
                    <li class="active">
                        <a href="#asset_tab" data-toggle="tab">
                            ...
                            <span class="hidden-xs hidden-sm">{{ trans('general.assets') }}
                                {!! $company->assets &&
                                $company->assets()->AssetsForShow()->count() > 0
                                    ? '<badge class="badge badge-secondary">' .
                                        number_format(
                                            $company->assets()->AssetsForShow()->count(),
                                        ) .
                                        '</badge>'
                                    : '' !!}
                    ...
                    <li>
                        {{-- <a href="#consumables_tab" data-toggle="tab">
                            ...
                            <span class="hidden-xs hidden-sm">{{ trans('general.consumables') }}
                                {!! $company->consumables && $company->consumables->count() > 0
                                    ? '<badge class="badge badge-secondary">' . number_format($company->consumables->count()) . '</badge>'
                                    : '' !!}
                            </span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#components_tab" data-toggle="tab">
                            ...
                            <span class="hidden-xs hidden-sm">{{ trans('general.components') }}
                                {!! $company->components && $company->components->count() > 0
                                    ? '<badge class="badge badge-secondary">' . number_format($company->components->count()) . '</badge>'
                                    : '' !!}
                            </span>
                        </a>
                    </li> --}}
                    ...
                    <li>
                        <a href="#users_tab" data-toggle="tab">
                            ...
                            <span class="hidden-xs hidden-sm">{{ trans('general.people') }}
                                {!! $company->users && $company->users->count() > 0
                                    ? '<badge class="badge badge-secondary">' . number_format($company->users->count()) . '</badge>'
                                    : '' !!}
                            </span>
                        </a>
                    </li>
                    ...
                    {{-- <div class="tab-pane" id="consumables_tab">
                        <div class="table-responsive">
                            ...
                            <table data-columns="{{ \App\Presenters\ConsumablePresenter::dataTableLayout() }}"
                                data-cookie-id-table="consumablesTable" data-pagination="true"
                                data-id-table="consumablesTable" data-search="true" data-side-pagination="server"
                                data-show-columns="true" data-show-export="true" data-show-refresh="true"
                                data-sort-order="asc" id="consumablesTable" class="table table-striped snipe-table"
                    ...
                    <div class="tab-pane" id="users_tab">
                        <div class="table-responsive">
                            ...
                            <table data-columns="{{ \App\Presenters\UserPresenter::dataTableLayout() }}"
                                ...
                                data-show-export="true" data-show-refresh="true" data-sort-order="asc" id="usersTable"
                                class="table table-striped snipe-table"
