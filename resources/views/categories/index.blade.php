            ...
            <div class="box box-default">
                <div class="box-body">
                    <div class="table-responsive" >
                        <table data-columns="{{ \App\Presenters\CategoryPresenter::dataTableLayout() }}"
                            data-cookie-id-table="categoryTable" data-pagination="true" data-id-table="categoryTable"
                            ...
                            data-sort-order="asc" id="categoryTable" class="table table-striped snipe-table"
