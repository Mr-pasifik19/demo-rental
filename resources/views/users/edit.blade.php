                                        ...
                                        <div
                                            ...
                                            @if ($user->ldap_import != '1' || str_contains(Route::currentRouteName(), 'clone'))
                                                <input class="form-control" type="text" name="username" id="username"
                                                    ...
                                                    maxlength="191" readonly onfocus="this.removeAttribute('readonly');"
                                   ...
                                   <div class="controls">
                                    <select
                                        ...
                                        @endforeach
                                                        ...
                                                        @endif
                                                    @else
                                                        {{-- <p>You can set the <code>Permission of this User / In the "Permission" Option Above </code> before completing of creating this account.</p>  --}}
                                                    @endif
