                        ...
                        <div class="col-md-9">
                          ...
                          @endif
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            {!! $user->vip == '1'
                                                ? '<i class="fas fa-check fa-fw fa-fw text-success" aria-hidden="true"></i> ' . trans('general.yes')
                                        ...
                                        @if (Auth::user()->isSuperUser() &&
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <a class="btn btn-default btn-sm" id="two_factor_reset"
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $("#two_factor_reset_toggle").html('').html(
                            '<span class="text-danger"><i class="fas fa-times" aria-hidden="true"></i> {{ trans('general.no') }}</span>'
                            );
