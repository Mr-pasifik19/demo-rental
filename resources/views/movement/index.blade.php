...
@section('title0')
    ...
    @if (Request::query('status') == 'openMovement')
        Open {{ trans('general.movement') }}
    @elseif (Request::query('status') == 'movementReturn')
        Return {{ trans('general.movement') }}
    @else
...
@section('header_right')
    ...
    @can('create', \App\Models\Movement::class)
        <a href="{{ route('movement.create') }}" accesskey="n" class="btn btn-primary pull-right"></i>
            ...
            <div class="box-body" style="overflow: auto;">
                <form action="{{ route('movement.index') }}" method="get">
                    ...
                    <div class="form-group pull-right">
                        <input type="text" id="search" name="searchMovement" class="form-control"
                                                ...
                                                @if ($categoryMovementArray[$key] === '0')
                                                    <div class="col-sm-2 p-2 mb-5 mb-sm-0"
                                                        ...
                                                        <span data-tooltip="true"
                                                            title="Return this movement {{ $number }}"
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-md-7 col-sm-12">
                                                            <select name="format_date"
                                                                id="format_date{{ $movementIdsArray[$key] }}"
                ...
                <div class="row w-100">
                    <div class="col-md-6">
                        <div class="justify-content-center" style="margin-top: 20px">
                            <p>Showing 1 to {{ count($movementData) }} project movements</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <nav aria-label="pagination-movement">
                            <ul class="pagination pull-right">
                                <li class="page-item {{ $movementData->currentPage() == 1 ? 'disabled' : '' }}">
                                    <a class="page-link" href="{{ $movementData->previousPageUrl() }}"
                    ...
                    if (formatDate.val() === "") {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                var formatSelect = $('#format_date' + index);
