...
{{--        <div><strong>Oceanside Solutions LLS</strong></div>--}}
...
{{--    @endif--}}
    ...
    <div class="card">
        <strong>Oceanside Solutions LLC</strong>
        <img src="{{ config('app.url') }}/hardware/{{ $asset->id }}/qr_code">
        <p>Asset Number: {{ $asset->serial }}</p>
        <button id="print-button" onclick="window.print();">Print this QR</button>
    </div>
