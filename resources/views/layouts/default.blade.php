        ...
        <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="left-navblock">
                    @if ($snipeSettings->brand == '3')
                        <a class="logo navbar-brand no-hover" href="{{ config('app.url') }}">
                            ...
                            @endif
                            <p style="font-size: 20px;">{{ $snipeSettings->site_name }}</p>
                        </a>
                    ...
                    @else
                        <a class="logo navbar-brand no-hover" href="{{ config('app.url') }}" style="font-size: 12px;">
                            {{ $snipeSettings->site_name }}
                        </a>
                    @endif
                </div>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    {{-- Percoobaan movement --}}
                    @can('index', \App\Models\MovementsModel::class)
                        <li aria-hidden="true" {!! Request::is('movement*') ? ' class="active"' : '' !!} tabindex="-1">
                            <a href="{{ url('movement') }}" accesskey="1" tabindex="-1">
                                <i class="fas fa-save fa-fw" aria-hidden="true"></i>
                                <span class="sr-only">{{ trans('general.movement') }}</span>
                            </a>
                        </li>
                    @endcan
                        ...
                        <li class="dropdown" aria-hidden="true">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                @can('create', \App\Models\ProjectMovement::class)
                                    <li {!! Request::is('project-movement/create') ? 'class="active>"' : '' !!}>
                                        <a href="{{ route('project-movement.create') }}" tabindex="-1">
                                            <i class="fas fa-book fa-fw" aria-hidden="true"></i>
                                            {{ trans('general.project_movement') }}
                                        </a>
                                    </li>
                                @endcan
                                @can('create', \App\Models\MovementsModel::class)
                                    <li {!! Request::is('movement/create') ? 'class="active>"' : '' !!}>
                                        <a href="{{ route('movement.create') }}" tabindex="-1">
                                            <i class="fas fa-save fa-fw" aria-hidden="true"></i>
                                            {{ trans('general.movement') }}
                                        </a>
                                    </li>
                                @endcan

                                @can('create', \App\Models\BranchCompany::class)
                                    <li {!! Request::is('company-movement/create') ? 'class="active>"' : '' !!}>
                                        <a href="{{ route('company-movement.create') }}" tabindex="-1">
 ...
 --}}
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                @can('index', \App\Models\Asset::class)
                    <li class="treeview{{ Request::is('statuslabels/*') || Request::is('hardware*') ? ' active' : '' }}">
                        ...
                        <ul class="treeview-menu">
                            ...
                            {{-- BulkCheckout utk pilih item project --}}
                ...
                @endcan
                @can('index', \App\Models\MovementsModel::class)
                    <li class="treeview{{ Request::is('statuslabels/*') || Request::is('movement*') ? ' active' : '' }}">
                        <a href="#"><i class="fas fa-save fa-fw" aria-hidden="true"></i>
                            <span>{{ trans('general.movement') . 's' }}</span>
                            <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <li>
                            ...
                            <li {!! Request::query('status') == 'openMovement' ? ' class="active"' : '' !!}>
                                <a href="{{ url('movement?status=openMovement') }}">
                                    <i class="far fa-circle text-blue fa-fw"></i>
                                    {{ trans('general.all') }}
                                    {{ trans('general.openMovement') }}
                                    ({{ isset($total_open_movement) ? $total_open_movement : '0' }})
                                </a>
                            </li>
                            <li {!! Request::query('status') == 'movementReturn' ? ' class="active"' : '' !!}>
                                <a href="{{ url('movement?status=movementReturn') }}">
                                    <i class="far fa-circle text-green fa-fw"></i>
                                    {{ trans('general.all') }}
                                    {{ trans('general.movementReturn') }}
                                    ({{ isset($total_return_movement) ? $total_return_movement : '0' }})
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                @can('view', \App\Models\ProjectMovement::class)
                    <li {!! Request::is('project-movement*') ? ' class="active"' : '' !!}>
                        <a href="{{ route('project-movement.index') }}" accesskey="6">
                            <i class="fas fa-book fa-fw"></i>
                            <span>{{ trans('general.project') . 's' }}</span>
                        </a>
                    </li>
                @endcan
                @can('view', \App\Models\BranchCompany::class)
                    <li {!! Request::is('company-movement*') ? ' class="active"' : '' !!}>
                        <a href="{{ route('company-movement.index') }}" accesskey="6">
                            <i class="fas fa-building fa-fw"></i>
                            <span>{{ trans('general.company_movement') }}</span>
                        </a>
                    </li>
                @endcan
    ...
    <div class="content-wrapper" role="main" id="setting-list">
        ...
        <section class="content-header" style="padding-bottom: 30px;">
            <h1 class="pull-left pagetitle">@yield('title') @stack('link-page') </h1>
    ...
    <footer class="main-footer hidden-print">
        ...
        <a target="_blank" href="https://www.oceansidesolutions.com/" rel="noopener">Oceanside Solutions LLC</a>
        <span>
            Is An <strong>Asset's Management & Tracking System</strong>
            of Oceanside Solutions LLC for <strong>Marine Projects</strong>.
        </span>
    </footer>
            ...
            <div class="modal-header">
                ...
                <h2 class="modal-title" id="myModalLabel">&nbsp;
                    @php
                        ...
                        } elseif (Request::is('fields*')) {
                            $titleDelete = 'Delete field';
                        } elseif (Request::is('statuslabels*')) {
                            $titleDelete = 'Delete status label';
                        } elseif (Request::is('categories*')) {
                            $titleDelete = 'Delete category';
                        } elseif (Request::is('models*')) {
                            $titleDelete = 'Delete asset model';
                        } elseif (Request::is('manufacturers*')) {
                            $titleDelete = 'Delete manufacturer';
                        } elseif (Request::is('suppliers*')) {
                            $titleDelete = 'Delete supplier';
                        } elseif (Request::is('departments*')) {
                            $titleDelete = 'Delete department';
                        } elseif (Request::is('locations*')) {
                            $titleDelete = 'Delete location';
                        } elseif (Request::is('companies*')) {
                            $titleDelete = 'Delete company';
                        } elseif (Request::is('depreciations*')) {
                            $titleDelete = 'Delete depreciation';
                        }
                    @endphp
                    {{ $titleDelete }}
                </h2>
