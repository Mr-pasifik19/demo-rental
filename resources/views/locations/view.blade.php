                ...
                <ul class="nav nav-tabs hidden-print">
                        ...
                        <a href="#users" data-toggle="tab">
                            ...
                            <span class="hidden-xs hidden-sm">
                                ...
                                {!! $location->users && $location->users->count() > 0
                                    ? '<badge class="badge badge-secondary">' . number_format($location->users->count()) . '</badge>'
                                    : '' !!}
                    ...
                    <li>
                        <a href="#assets" data-toggle="tab">
                            ...
                            <span class="hidden-xs hidden-sm">
                                {{ trans('admin/locations/message.assets') }}
                                {!! $location->assets &&
                                $location->assets()->AssetsForShow()->count() > 0
                                    ? '<badge class="badge badge-secondary">' .
                                        number_format(
                                            $location->assets()->AssetsForShow()->count(),
                                        ) .
                                        '</badge>'
                                    : '' !!}
                            </span>
                    ...
                    {{-- <li>
                        <a href="#rtd_assets" data-toggle="tab">
                            ...
                            <span class="hidden-xs hidden-sm">
                                {{ trans('admin/hardware/form.assets-inproject') }}
                                {!! $location->rtd_assets &&
                                $location->rtd_assets()->AssetsForShow()->count() > 0
                                    ? '<badge class="badge badge-secondary">' .
                                        number_format(
                                            $location->rtd_assets()->AssetsForShow()->count(),
                                        ) .
                                        '</badge>'
                                    : '' !!}
                            </span>
                        ...
                        <a href="#assets_assigned" data-toggle="tab">
                            ...
                            <span class="hidden-xs hidden-sm">
                                ...
                                $location->assignedAssets()->AssetsForShow()->count() > 0
                                    ? '<badge class="badge badge-secondary">' .
                                        number_format(
                                            $location->assignedAssets()->AssetsForShow()->count(),
                                        ) .
                                        '</badge>'
                                    : '' !!}
                            </span>
                    ...
                    <li>
                        <a href="#accessories" data-toggle="tab">
                            ...
                            <span class="hidden-xs hidden-sm">
                                ...
                                {!! $location->accessories && $location->accessories->count() > 0
                                    ? '<badge class="badge badge-secondary">' . number_format($location->accessories->count()) . '</badge>'
                                    : '' !!}
                            </span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#consumables" data-toggle="tab">
                            ...
                            <span class="hidden-xs hidden-sm">
                                ...
                                {!! $location->consumables && $location->consumables->count() > 0
                                    ? '<badge class="badge badge-secondary">' . number_format($location->consumables->count()) . '</badge>'
                                    : '' !!}
                            </span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#components" data-toggle="tab">
                            ...
                            <span class="hidden-xs hidden-sm">
                                ...
                                {!! $location->components && $location->components->count() > 0
                                    ? '<badge class="badge badge-secondary">' . number_format($location->components->count()) . '</badge>'
                                    : '' !!}
                            </span>
                        </a>
                    </li> --}}
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="assets">
                        ...
                        <table data-columns="{{ \App\Presenters\AssetPresenter::dataTableLayout() }}"
                            ...
                            data-bulk-form-id="#assetsBulkForm" data-click-to-select="true" id="assetsListingTable"
                            class="table table-striped snipe-table"
                    ...
                    {{-- <div class="tab-pane" id="rtd_assets">
                        ...
                        <table data-columns="{{ \App\Presenters\AssetPresenter::dataTableLayout() }}"
                            ...
                            data-bulk-form-id="#RTDassetsBulkEditToolbar" data-click-to-select="true"
                            id="RTDassetsListingTable" class="table table-striped snipe-table"
                    ...
                    {{-- <div class="tab-pane" id="accessories">
                        ...
                        <div class="table table-responsive">
                            <table data-columns="{{ \App\Presenters\AccessoryPresenter::dataTableLayout() }}"
                                ...
                                data-show-columns="true" data-show-export="true" data-show-refresh="true"
                                data-sort-order="asc" id="accessoriesListingTable"
                                class="table table-striped snipe-table"
                    ...
                    <div class="tab-pane" id="consumables">
                        ...
                        <div class="table table-responsive">
                            <table data-columns="{{ \App\Presenters\ConsumablePresenter::dataTableLayout() }}"
                                ...
                                data-show-columns="true" data-show-export="true" data-show-refresh="true"
                                data-sort-order="asc" id="consumablesListingTable"
                                class="table table-striped snipe-table"
        ...
        <div class="col-md-3">
            ...
            <div class="col-md-12">
                <a href="{{ route('locations.edit', ['location' => $location->id]) }}" style="width: 100%;"
                    class="btn btn-sm btn-primary pull-left">{{ trans('admin/locations/table.update') }} </a>
            </div>
            {{-- <div class="col-md-12" style="padding-top: 5px;">
                <a href="{{ route('locations.print_assigned', ['locationId' => $location->id]) }}" style="width: 100%;"
                    class="btn btn-sm btn-default pull-left">{{ trans('admin/locations/table.print_assigned') }} </a>
            </div>
            <div class="col-md-12" style="padding-top: 5px; padding-bottom: 20px;">
                <a href="{{ route('locations.print_all_assigned', ['locationId' => $location->id]) }}" style="width: 100%;"
                    class="btn btn-sm btn-default pull-left">{{ trans('admin/locations/table.print_all_assigned') }} </a>
            </div> --}}
