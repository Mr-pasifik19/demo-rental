...
return [
    ...
    'help' => [
        'undeployable'   => 'These assets cannot be rented to anyone.',
        'deployable'   => 'These assets can be checked out. Once they are assigned, they will assume a meta status of <i class="fas fa-circle text-blue"></i> <strong>Rented</strong>.',
